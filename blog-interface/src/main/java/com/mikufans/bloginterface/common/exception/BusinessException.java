...
public class BusinessException extends RuntimeException {
    ...
    protected RestResponseDto apiResponse;
    ...
    public static BusinessException fromAPIResponse(RestResponseDto apiResponse) {
        BusinessException businessException = new BusinessException();
        if(apiResponse == null) {
            apiResponse = RestResponseDto.fail("NULL");
        }
    ...
    public RestResponseDto response() {
        if(this.apiResponse != null) {
            return this.apiResponse;
        } else {
            this.apiResponse = new RestResponseDto(false);
