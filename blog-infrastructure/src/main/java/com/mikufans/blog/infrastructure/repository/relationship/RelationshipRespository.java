...
@Mapper
public interface RelationshipRespository {
    /**
     * 添加
     * @param relationShip
     * @return
     */
    int addRelationShip(RelationshipPo relationShip);
     ...
     * @return
     */
    int updateRelationShip(RelationshipPo relationShip);
     ...
     * @return
     */
    List<RelationshipPo> getRelationShipByCid(@Param("cid") Integer cid);
     ...
     * @return
     */
    List<RelationshipPo> getRelationShipByMid(@Param("mid") Integer mid);
